      ...
      <div className="">
          ...
          ">
            <AnimateOnView direction="right" delay={0.2}>
                ...
                lg:pb-15 lg:px-15
                ">
                  <h1 className="ibx-plex-mono text-[22px] text-[white]
                  md:text-3xl
                  ">WHEN HISTORY REIMAGINED TO FRAGRANCE</h1>
                  <p className="founders-grotesk-l text-white text-[14px] w-[260px] text-justify
                  ...
                  <Link href="/product">
                    <button className="ibx-plex-mono text-white text-start underline text-[12px] cursor-pointer
                    md:text-lg
          ...
          {/* New Arrival Section */}
          <div className="bg-[#F2EDE6] px-6 py-8 flex gap-2
          md:gap-5
          ...
          ">
            <AnimateOnView direction="left" delay={0.2}>
                ...
                ">
                  <h2 className="ibx-plex-mono font-bold text-[14px]
                  md:text-[24px]
                  lg:text-[32px]
                  ">NEW ARTICLE</h2>
                  <p className="founders-grotesk-l text-[24px] text-white
                  md:text-[48px]
                  lg:text-[64px]
                  ">EARHART</p>
                </div>
              ...
              <AnimateOnView direction="right" delay={0.4}>
                <div className="lg:text-end lg:mb-5">
                    <div>
                      <h3 className="ibx-plex-mono font-bold text-[16px]
                      md:text-[20px]
                      lg:text-[26px]
                      ">Top Notes:</h3>
                      <p className="founders-grotesk-l text-[14px]
                      md:text-[18px]
                      lg:text-[22px]
                    ...
                    <Link href="/detail/3">
                      <button className="ibx-plex-mono text-white bg-black text-[8px] w-full py-2 cursor-pointer
                      md:text-[16px]
                      lg:text-[20px]
                      ">VIEW PRODUCT</button>
                    </Link>
          ...
          ">
            ...
            <AnimateOnView direction="up" delay={0.2}>
              ...
              ">
                ...
                lg:w-[450px]
                " />
                <p className="founders-grotesk-l text-[12px] w-[215px] text-justify pr-3 pl-2
                ...
                <Link href="/about">
                  <button className="ibx-plex-mono underline text-[10px] font-semibold self-end text-end pl-2 mt-5
                  md:text-[16px]
                  ">LEARN MORE</button>
                </Link>
              </div>
          ...
          <div className="bg-[#F2EDE6] px-6 py-6
          lg:p-15
          ">
          ...
          <AnimateOnView direction="right" delay={0.2}>
            ...
            lg:p-15
            ">
              <p className="w-[270px] founders-grotesk-l text-[14px] text-justify
          ...
          ">
            ...
            ">VIEW COLLECTION</h2>
            <Link href="/product">
              <button className="ibx-plex-mono text-white text-[12px] bg-[#242424] px-7 py-2 cursor-pointer hover:opacity-85 rounded-[5px]
