            ...
            <div>
                ...
                '>
                    ...
                    lg:justify-center lg:px-20 bg-[#f0d3ad]'>
                        <h2 className='founders-grotesk-m text-[16px]
                        md:text-[24px]
                        '>{filteredProduct.name}</h2>
                        <p className='founders-grotesk-r text-[14px]
                        md:text-[20px]
                        '>{filteredProduct.size}</p>
                        <p className='founders-grotesk-r text-[14px] text-[#777777] mt-3
                        md:text-[18px]
                ...
                '>
                    <p className='founders-grotesk-r text-[17px] mt-5 text-justify leading-6 px-6
                    md:text-[20px]
                    lg:w-[700px] lg:mx-20 lg:my-20
                    '>{filteredProduct.description}</p>
                    <img src={filteredProduct.image[2]} alt="" className='w-[600px] h-[600px] object-cover
                    hidden
                    lg:block
                    ' />
                </div>
                <div className="w-full h-[300px] bg-cover bg-center my-5 p-6 pb-15 flex justify-end
                md:h-[350px]
                lg:h-[700px]
                " style={{ backgroundImage: `url(${filteredProduct.bgimage})` }}>
                    <div className='p-6 w-[300px] flex flex-col gap-2 bg-black/35 h-full justify-center
                    lg:w-[500px] lg:mr-30 lg:h-[400px]
                    '>
                        <div>
                            <h3 className='ibx-plex-mono text-[14px] font-medium text-white
                            md:text-[18px]
                            lg:text-[26px]
                            '>Top Notes:</h3>
                            <p className='founders-grotesk-l text-[14px] text-white
                            md:text-[16px]
                            lg:text-[22px]
                ...
                lg:px-25
                '>
                    <p className='founders-grotesk-l italic text-[15px] text-justify mb-5 w-[270px]
